 ...
 * <li>{@link sofia.graphics.ImageShape}</li>
 * <li>{@link sofia.graphics.SVGShape} (for nicely scaled SVG vector art)</li>
 ...
 * {@link sofia.graphics.ImageShape} to create a few classes that represent
